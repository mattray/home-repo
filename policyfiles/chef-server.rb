...
run_list 'mattray', 'mattray::effortless-audit', 'chef-client::config', 'apt::cacher-client', 'systemd_timesyncd', 'mattray::macbookpro', 'openssh', 'chef_client_updater', 'leds_handler', 'managed_chef_server', 'managed_chef_server::managed_organization', 'managed_chef_server::policyfile_loader', 'starship'
